...
const mockOrder = {
  ...
  totalAmount: 5.1,
  paidAmount: 5.1,
  startAddress: '中心商务区 · 国贸大厦',
  endAddress: '科技园区 · 创新中心',
};
    ...
    <div className="min-h-screen bg-gray-50 pb-8">
        ...
        {loading ? (
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <span className="text-white/80 text-sm">骑行已结束</span>
            </div>
      ...
      <div className="px-4 -mt-8 space-y-4">
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{order.startTime.split(' ')[0]}</p>
                  </div>
                </div>
              ...
              <div className="relative py-4">
                ...
                <div className="flex items-start gap-4 mb-6 relative">
                  ...
                  <div className="flex-1">
                    <p className="text-gray-900 font-medium">{order.startAddress}</p>
                ...
                <div className="flex items-start gap-4 relative">
                  ...
                  <div className="flex-1">
                    <p className="text-gray-900 font-medium">{order.endAddress}</p>
                    <p className="text-sm text-gray-500 mt-1">
        ...
        <Card padding="none" hoverable={false}>
          <button
            onClick={() => navigate(`/complaint?orderId=${orderId}`)}
